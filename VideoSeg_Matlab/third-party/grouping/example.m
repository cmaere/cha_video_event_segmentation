...
imgFile = 'data/img_000.ppm';
outFile = 'data/img_000_gPb.mat';
rsz = 0.5;
...
load data/img_000_gPb.mat gPb_orient

% for boundaries
ucm = contours2ucm(gPb_orient, 'imageSize');
imwrite(ucm,'data/img_000_ucm.bmp');

% for regions
ucm2 = contours2ucm(gPb_orient, 'doubleSize');
imwrite(ucm2,'data/img_000_ucm2.bmp');
return;
%% usage example
