...
system(sprintf('LD_LIBRARY_PATH=/usr/local/matlab75/sys/os/glnxa64/:$LD_LIBRARY_PATH %s/third-party/grouping/lib/segment -image %s -smatrixfile %s -readlattice true -latticefile %s -dthresh 5', pwd, imgFile, simFile, latFile));
